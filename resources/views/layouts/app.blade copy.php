<!DOCTYPE html>
<head>
    <title>@yield('title', 'Ashkan Music')</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="/front/js/plugins/swiper/css/swiper.min.css">
    <link rel="stylesheet" type="text/css" href="/front/js/plugins/nice_select/nice-select.css">
    <link rel="stylesheet" type="text/css" href="/front/js/plugins/player/volume.css">
    <link rel="stylesheet" type="text/css" href="/front/js/plugins/scroll/jquery.mCustomScrollbar.css">
...
<div class="ms_main_wrapper">
    ...
    <div class="ms_sidemenu_wrapper">
        ...
        <div class="ms_sidemenu_inner">
            <div class="ms_logo_inner">
                <div class="ms_logo">
                    <a href="index.html"><img src="/front/images/logo.png" alt="" class="img-fluid"/></a>
                </div>
                <div class="ms_logo_open">
                    <a href="index.html"><img src="/front/images/open_logo.png" alt="" class="img-fluid"/></a>
                </div>
            </div>
        ...
        <div class="ms_header">
            <div class="ms_top_left">
                <div class="ms_top_search">
                    ...
                    <span class="search_icon">
							<img src="/front/images/svg/search.svg" alt="">
						</span>
                </div>
            ...
            <div class="ms_top_right">
                <div class="ms_top_lang">
                    <span data-toggle="modal" data-target="#lang_modal">languages <img src="/front/images/svg/lang.svg" alt=""></span>
                </div>
    ...
    <div class="ms_footer_wrapper">
        <div class="ms_footer_logo">
            <a href="index.html"><img src="/front/images/open_logo.png" alt=""></a>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_box footer_app">
                        ...
                        <a href="#" class="foo_app_btn"><img src="/front/images/google_play.jpg" alt="" class="img-fluid"></a>
                        <a href="#" class="foo_app_btn"><img src="/front/images/app_store.jpg" alt="" class="img-fluid"></a>
                        <a href="#" class="foo_app_btn"><img src="/front/images/windows.jpg" alt="" class="img-fluid"></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                        ...
                        <ul class="foo_con_info">
                            <li>
                                <div class="foo_con_icon">
                                    <img src="/front/images/svg/phone.svg" alt="">
                                </div>
                            ...
                            <li>
                                <div class="foo_con_icon">
                                    <img src="/front/images/svg/message.svg" alt="">
                                </div>
                                <div class="foo_con_data">
                            ...
                            <li>
                                <div class="foo_con_icon">
                                    <img src="/front/images/svg/add.svg" alt="">
                                </div>
                                <div class="foo_con_data">
        ...
        <div class="col-lg-12">
            <div class="ms_copyright">
                ...
                <p>Copyright &copy; 2018 <a href="https://www.mellatweb.com/"> Mellatweb.com</a>. All Rights Reserved.</p>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="knob-wrapper-outer">
                                        <div class="knob-wrapper">
                                            <div class="knob-mask">
                                                ...
                                                <div class="round">
                                                    <img src="/front/images/svg/volume.svg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- <input></input> -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ms_register_img">
                        <img src="/front/images/register_img.png" alt="" class="img-fluid" />
                    </div>
...
<script type="text/javascript" src="/front/js/plugins/swiper/js/swiper.min.js"></script>
<script type="text/javascript" src="/front/js/plugins/player/jplayer.playlist.min.js"></script>
<script type="text/javascript" src="/front/js/plugins/player/jquery.jplayer.min.js"></script>
<script type="text/javascript" src="/front/js/plugins/player/audio-player.js"></script>
<script type="text/javascript" src="/front/js/plugins/player/volume.js"></script>
<script type="text/javascript" src="/front/js/plugins/nice_select/jquery.nice-select.min.js"></script>
<script type="text/javascript" src="/front/js/plugins/scroll/jquery.mCustomScrollbar.js"></script>
